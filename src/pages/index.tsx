    ...
    <div className="flex flex-row bg-gray-200">
      ...
      <div className="w-full p-2 md:p-10">
        <div className="bg-white mx-auto flex flex-col justify-center align-middle shadow-lg min-h-full p-2 md:p-10">
          ...
          <p>
            Welcome to riceboyler.com, the online home of Jason Clark, currently
            a resident of Cedar City, Utah, USA. This site is an exercise in
            using GatsbyJS, along with the excellent Tailwind CSS Utility
            library. Using the links to the left, you can go to different pages
            to learn more about what I do for work, me (and my family) or even
            read some ramblings from my blog posts.
          </p>
          <p>
